...
(function() {
    var animation = {
      ...
      year: function(className) {
        ...
        for (var i=0; i<="08-03-".concat(String(animation.period.year)).length-1; i++) {
          var digit = animation.element(year, "div", "digit", ("08-03-".concat(String(animation.period.year))).substr(i, 1));
